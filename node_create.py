...
def node_create(match_node,node_object):
	...
	for index in initialize.element:
		node = BaseNode(node_object[index]['ip'],node_object[index]['hostname'],node_object[index]['platform'],node_object[index]['opersys'],node_object[index]['type'],node_object[index]['role'])
